...
const translations = {
  ...
  he: {
    ...
    // About
    aboutTitle: 'אודותינו',
    aboutText: 'ברוכים הבאים לאלה ברבר שופ, שם המסורת פוגשת סטייל מודרני. בהובלת עלי, הספר המנוסה שלנו, אנחנו מספקים שירותי טיפוח יוצאי דופן לג\'נטלמן המודרני. עם תשומת לב לפרטים ותשוקה לשלמות, אנחנו מבטיחים שכל לקוח יוצא נראה ומרגיש במיטבו.',
